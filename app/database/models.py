...
class Submission(Base):
    ...
    processed_image_path: Mapped[Optional[str]] = mapped_column(String(512), nullable=True)
    generated_png_path: Mapped[Optional[str]] = mapped_column(String(512), nullable=True)
    ...
    replacement_images: Mapped[Dict[str, Any]] = mapped_column(JSON, default=dict, nullable=False)
